 ...
 * @author  AlwaysXu
 */
public class ZzPigServiceOld {

    public ZzPigServiceOld() {
    }

    public ZzPigServiceOld(String method, String viewObjectName, Map<String, List<Object>> reqMap) {
...
//            }
            ...
            //通过反射实例化类
            Class c = Class.forName("com.bluedot.pig.service.ZzPigServiceOld");
