...
<div class="tpl-page-container tpl-page-header-fixed">
    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold"> <span class="am-icon-code"></span> 饲喂详细设定 </div>
        ...
        <div class="tpl-block ">
            <div class="am-g tpl-amazeui-form">
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" action="/feedStandardList/PigService/update/feedStandard.do"
                        ...
                        <div class="am-form-group" style="width: 50%;float: left">
                            ...
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="feedSettingNo"   placeholder="1" name="feedSettingNo" value="${feed.feedSettingNo}" readonly>
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="pigVarietyId" class="am-u-sm-3 am-form-label">品种</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="pigVarietyId"  placeholder="浙江金华猪" name="pigVarietyId" value="${feed.pigVarietyId}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="sex" class="am-u-sm-3 am-form-label">性别</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="sex"  placeholder="公" name="sex" value="${feed.sex}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="pigType" class="am-u-sm-3 am-form-label">类型</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="pigType"  placeholder="育肥猪" name="pigType" value="${feed.pigType}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="pigState" class="am-u-sm-3 am-form-label">状态</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="pigState"  placeholder="出栏" name="pigState" value="${feed.pigState}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="growthStage" class="am-u-sm-3 am-form-label">生长阶段</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="growthStage"  placeholder="保育期" name="growthStage" value="${feed.growthStage}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="foodRate" class="am-u-sm-3 am-form-label">饲料比例</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="foodRate"  placeholder="0.4" name="foodRate" value="${feed.foodRate}">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group" style="width: 50%;float: left">
                            ...
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="waterRate"  placeholder="0.3" name="waterRate" value="${feed.waterRate}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="drugRate" class="am-u-sm-3 am-form-label">药品比例</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="drugRate"  placeholder="0.3" name="drugRate" value="${feed.drugRate}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="totalWeight" class="am-u-sm-3 am-form-label">饲喂总量(kg)</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="totalWeight"  placeholder="5kg" name="totalWeight" value="${feed.totalWeight}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="feedCount" class="am-u-sm-3 am-form-label">饲喂次数</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="feedCount"  placeholder="10" name="feedCount" value="${feed.feedCount}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="feedTime" class="am-u-sm-3 am-form-label">饲喂开始时间</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="feedTime" placeholder="12:00" name="feedTime" value="${feed.feedTime}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="feedLastTime" class="am-u-sm-3 am-form-label">饲喂持续时间(分钟)</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="feedLastTime"  placeholder="30min" name="feedLastTime" value="${feed.feedLastTime}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="feedIntervalTime" class="am-u-sm-3 am-form-label">饲喂间隔时间(小时)</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="feedIntervalTime"  placeholder="4小时" name="feedIntervalTime" value="${feed.feedIntervalTime}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="upperWeight" class="am-u-sm-3 am-form-label">日增重上限(kg)</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="upperWeight"  placeholder="10kg" name="upperWeight" value="${feed.upperWeight}">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group" style="width: 50%;float: left">
                            ...
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="lowerWeight"  placeholder="2kg" name="lowerWeight" value="${feed.lowerWeight}">
                            </div>
                        </div>
                        <div class="am-form-group" style="width: 50%;float: left">
                            <label for="realName" class="am-u-sm-3 am-form-label">设置人</label>
                            <div class="am-u-sm-9" style="width: 50%;margin-right:15%">
                                <input type="text" id="realName"  placeholder="10kg" name="realName" value="${feed.realName}">
                            </div>
                        </div>
