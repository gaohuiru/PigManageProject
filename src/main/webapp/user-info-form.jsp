                    ...
                    <div class="am-u-sm-12 am-u-md-9">
                        <form class="am-form am-form-horizontal">
                            <div class="am-form-group">
                                ...
                                <label for="user-name" class="am-u-sm-3 am-form-label info">2017103</label>
                                <!--</div>-->
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <!-- <input type="email" id="user-email" placeholder="输入你的电子邮件 / Email">
                                    <small>邮箱你懂得...</small> -->
                                <label for="user-name" class="am-u-sm-3 am-form-label info">蓝点工作室</label>
                                <!--</div>-->
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <label for="user-name" class="am-u-sm-3 am-form-label info">男</label>
                            </div>

                            <div class="am-form-group">
                                <label for="user-QQ" class="am-u-sm-3 am-form-label">年龄：</label>
                                <!-- <input type="number" pattern="[0-9]*" id="user-QQ" placeholder="输入你的QQ号码"> -->
                                <label for="user-name" class="am-u-sm-3 am-form-label info">21</label>
                            </div>
                            <div class="am-form-group">
                                <label for="user-intro" class="am-u-sm-3 am-form-label">入职时间：</label>

                                <label for="user-name" class="am-u-sm-3 am-form-label info">2017-7</label>
                            </div>
                            <div class="am-form-group">
                                <label for="user-intro" class="am-u-sm-3 am-form-label">工龄：</label>

                                <label for="user-name" class="am-u-sm-3 am-form-label info">2年</label>
                            </div>
                            <div class="am-form-group">
                                <label for="user-weibo" class="am-u-sm-3 am-form-label">手机号：</label>
                                <!-- <input type="text" id="user-weibo" placeholder="输入你的微博 / Twitter"> -->
                                <label for="user-name" class="am-u-sm-3 am-form-label info">15179937160</label>
                            </div>

                            <div class="am-form-group">
                                <label for="user-intro" class="am-u-sm-3 am-form-label">邮箱：</label>
                                <!--  <textarea class="" rows="5" id="user-intro" placeholder="输入个人简介"></textarea>
                                    <small>250字以内写出你的一生...</small> -->
                                <label for="user-name" class="am-u-sm-3 am-form-label info">2671623283@qq.com</label>
                            </div>
                            <div class="am-form-group">
                                <label for="user-intro" class="am-u-sm-3 am-form-label">职位；</label>

                                <label for="user-name" class="am-u-sm-3 am-form-label info">仓库管理员</label>
                            </div>

                            <div class="am-form-group">
                                <label for="user-intro" class="am-u-sm-3 am-form-label">详细地址：</label>

                                <label for="user-name" class="am-u-sm-3 am-form-label info">江西农业大学</label>
                            </div>
                            <!-- <div class="am-form-group">
